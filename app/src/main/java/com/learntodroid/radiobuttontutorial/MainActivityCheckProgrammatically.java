...
public class MainActivityCheckProgrammatically extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkRadioButton_UsingRadioButtonSetChecked();
    }
    ...
    public void checkRadioButton_UsingRadioGroupCheck() {
        int index = new Random().nextInt(radioGroup.getChildCount());
        RadioButton rb = (RadioButton) radioGroup.getChildAt(index);
        radioGroup.check(rb.getId());
    }

    public void checkRadioButton_UsingRadioButtonSetChecked() {
        int index = new Random().nextInt(radioGroup.getChildCount());
        RadioButton rb = (RadioButton) radioGroup.getChildAt(index);
        rb.setChecked(true);
    }
